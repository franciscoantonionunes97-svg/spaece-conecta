...
- **Adicionar material direto na tela:** nas telas de **Atividades**, **Jogos** e **Simulados**, o administrador/técnico vê o botão **➕ Adicionar material**, que abre um formulário já com a categoria da tela (link ou PDF). O material fica imediatamente disponível para os professores. Professores e gestores não veem esse botão.
